...
describe("Create a query with a mongo datasource, run, save and then delete the query", function () {
    ...
    it("Create a query with form input with a mongo datasource, run, save and then delete the query", function () {
        ...
        cy.xpath("(//div[@class='t--form-control-QUERY_DYNAMIC_INPUT_TEXT']//pre[@class=' CodeMirror-line '])[2]")
