...
sudo curl -O https://raw.githubusercontent.com/appsmithorg/appsmith/feature/test-self-hosted-installation-script-testing/deploy/aws_ami/boot.sh
sudo curl -O https://raw.githubusercontent.com/appsmithorg/appsmith/feature/test-self-hosted-installation-script-testing/deploy/aws_ami/first-time-setup.sh
sudo curl -O https://raw.githubusercontent.com/appsmithorg/appsmith/feature/test-self-hosted-installation-script-testing/deploy/aws_ami/configure-ssl.sh
sudo curl -O https://raw.githubusercontent.com/appsmithorg/appsmith/feature/test-self-hosted-installation-script-testing/deploy/aws_ami/init-letsencrypt.sh
sudo curl -O https://raw.githubusercontent.com/appsmithorg/appsmith/feature/test-self-hosted-installation-script-testing/deploy/aws_ami/user-data.sh
...
echo "@reboot ubuntu $boot_script_path/$boot_file_name" | sudo tee -a $CRON_FILE
